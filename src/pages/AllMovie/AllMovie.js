...
import { getAllMovie1 } from "../../Redux/Actions/allMovie1Actions"
...
const AllMovie = ()=>{
    ...
    const {allmovies1} = useSelector((state) => state.allMovie1)

    

    useEffect(() => {
        dispatch(getAllMovie1())
    },[dispatch])
